...
type UserClient interface {
	...
	CreateUserByMobile(ctx context.Context, in *CreateUserByMobileReq, opts ...grpc.CallOption) (*CreateUserByMobileReply, error)
...
func (c *userClient) CreateUserByMobile(ctx context.Context, in *CreateUserByMobileReq, opts ...grpc.CallOption) (*CreateUserByMobileReply, error) {
	out := new(CreateUserByMobileReply)
	err := c.cc.Invoke(ctx, "/user.service.v1.User/CreateUserByMobile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) ListUsers(ctx context.Context, in *ListUsersReq, opts ...grpc.CallOption) (*ListUsersReply, error) {
	out := new(ListUsersReply)
	err := c.cc.Invoke(ctx, "/user.service.v1.User/ListUsers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	CreateUserByMobile(context.Context, *CreateUserByMobileReq) (*CreateUserByMobileReply, error)
...
func (UnimplementedUserServer) CreateUserByMobile(context.Context, *CreateUserByMobileReq) (*CreateUserByMobileReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateUserByMobile not implemented")
}
...
func (UnimplementedUserServer) ListUsers(context.Context, *ListUsersReq) (*ListUsersReply, error) {
...
func _User_CreateUserByMobile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateUserByMobileReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).CreateUserByMobile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.service.v1.User/CreateUserByMobile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).CreateUserByMobile(ctx, req.(*CreateUserByMobileReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _User_ListUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.service.v1.User/ListUsers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateUserByMobile",
			Handler:    _User_CreateUserByMobile_Handler,
		},
		{
			MethodName: "GetUser",
